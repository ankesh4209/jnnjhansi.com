...
$PAGE_CONTENTS	= ReadTemplate("$TEMPLATE_DIR/ward_wise_report.html");
...
function viewreports($db,$db1,$radioWard,$radioSingle,$radioAll,$WardNo,$PhysicalProgress,$Periods,$FromDate,$ToDate,$showreport)
 {
   ...
   global $TOTAL_RECORDSET,$PAGE_NAVS,$Status,$wardno,$workname,$WorkOrderNo,$estimateamt,$ContractorName,$appamt,$appdate,$workstartdate,$workenddate,$Payments,$CheckNos,$Comment,$MadName,$trclass,$WardWorkSummary;
...
fo”ks’k
 ...
 <span class="cancelledrowindicator" style="display:inline-block;">&nbsp;</span>&nbsp;<span style="font-family: kruti_dev_010regular;font-size:15PX;">dsfUly dk;Z </span>
   ...
   $strSql='';
   if($WardNo!=''){
	   $strSql.=" and cw_e.WardNo='$WardNo'";
	   $strSql2.=" and cw_e.WardNo='$WardNo'";
   ...
   $S1	= $S2 = ReadTemplate("$TEMPLATE_DIR/ward_wiseDisplayGrid.html");
