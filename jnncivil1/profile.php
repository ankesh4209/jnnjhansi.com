...
viewpage($db,$db1,$_SESSION['ContractorId']);

$PAGE_CONTENTS	= ReadTemplate("$TEMPLATE_DIR/profile.html");
   ...
   if($db->num_rows())
   {
              ...
              if($Isnewcharitrapramanpatra=='yes'){
				 ...
				 if($newcharitrapramanpatra!=''){
					 ...
					 $howoldnewcharitrapramanpatraLink="<a href='../newcharitrapramanpatra/$newcharitrapramanpatra' target='_new'>$newcharitrapramanpatra</a>";
            ...
            <td align='left' >
              ...
              if($Isshapathpatra=='yes'){
				 ...
				 if($shapathpatra!=''){
				     ...
				     $shapathpatraLink="<a href='../sapathpatra/$shapathpatra' target='_new'>$shapathpatra</a>";
					 $strsapthpatra="<tr>    
            ...
            <td align='left' colspan='2' >
              ...
              if($Ishashiyatpramanpatra=='yes'){
				 ...
				 if($hashiyatpramanpatra!=''){
					 ...
					 $hashiyatpramanpatraLink="<a href='../hashiyatpramanpatra/$hashiyatpramanpatra' target='_new'>$hashiyatpramanpatra</a>";
            ...
            <td align='left' colspan='2'>
              ...
              if($Isitccirtificate=='yes'){
				 ...
				 if($itccirtificate!=''){
					 ...
					 $itccirtificate="<a href='../itccirtificate/$itccirtificate' target='_new'>$itccirtificate</a>";
            ...
            <td align='left' colspan='2'>
              ...
              if($Isfirmristedar=='yes'){
				 ...
				 if($firmristedar!=''){
					 ...
					 $firmristedar="<a href='../firmristedar/$firmristedar' target='_new'>$firmristedar</a>";
					 $strfirmristedar="<tr>    
            <td align='left' colspan='2'>
                    <table cellspacing='0' cellpadding='0' border='0' width='100%'>
              ...
              if($Isfirmagainstkarywahi=='yes'){
				 ...
				 if($firmagainstkarywahi!=''){
					 $firmagainstkarywahi="<a href='../firmagainstkarywahi/$firmagainstkarywahi' target='_new'>$firmagainstkarywahi</a>";
					 $strkalisuchifirm="<tr>    
            <td align='left' colspan='2'>
                    <table cellspacing='0' cellpadding='0' border='0' width='100%'>
		  ...
		  $strarthdandfirm="<tr>    
             <td align='left' colspan='2'>
              ...
              if($Isfu_stoff=='yes'){
				 ...
				 if(!$fu_stoff!=''){
					 ...
					 $metno=$rows['metno'];
					 $anyano=$rows['anyano'];
					 $fu_stoff="<a href='../fu_stoff/$fu_stoff' target='_new'>$fu_stoff</a>";
					 $strfu_stoff="<tr>    
             <td align='left' colspan='2'>
                    <table cellspacing='0' cellpadding='0' border='0' width='100%'>
              ...
              if($Isvikashkarya=='yes'){
				 ...
				 if($vikashkarya!=''){
					 ...
					 $vikashkarya="<a href='../vikashkarya/$vikashkarya' target='_new'>$vikashkarya</a>";
					 $strvikashkarya="<tr>    
             <td align='left' colspan='2'>
                    <table cellspacing='0' cellpadding='0' border='0' width='100%'>
              ...
              if($Isanubhavpramarpatra=='yes'){
				 ...
				 if($anubhavpramarpatra!=''){
					 $anubhavpramarpatra="<a href='../anubhavpramarpatra/$anubhavpramarpatra' target='_new'>$anubhavpramarpatra</a>";
              ...
              if($Ismafiyashapathpatra=='yes'){
				 ...
				 if($mafiyashapathpatra!=''){
					 ...
					 $mafiyashapathpatra="<a href='../mafiyashapathpatra/$mafiyashapathpatra' target='_new'>$mafiyashapathpatra</a>";
             ...
             <td align='left' colspan='2'>
              ...
              if($Ispanjikaranrashid=='yes'){
				 ...
				 if($panjikaranrashid!=''){
					 $panjikaranrashid="<a href='../panjikaranrashid/$panjikaranrashid' target='_new'>$panjikaranrashid</a>";
