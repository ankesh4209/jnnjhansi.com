...
function EditProposedWork($db){
   ...
   $sql="update cw_proposedworks set WardNo='$WardNo',ProposerName='$ProposerName',JEEmployeeCode='$JEEmployeeCode',AEEmployeeCode='$AEEmployeeCode',EXnEmployeeCode='$EXnEmployeeCode',CEEmployeeCode='$CEofficers',WorkName='$WorkName',EstimatedAmount='$EstimatedAmount',ProposedWorkDate='$ProposedWorkDate' where ProposedId=$ProposedId";
	$db->query($sql);
	return 1;
}
