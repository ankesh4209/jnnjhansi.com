...
function addEstimate($db)
 {
		   ...
		   $insert="insert into cw_estimation(MadId,MadAmtId,WorkName,ProposerName,ItemQtys,TotalAmount,JEEmployeeCode,AEEmployeeCode,EXnEmployeeCode,WardNo,AreaName,AddedDate) values('".$MadId."','".$MadAmtId."','".$WorkName."','".$ProposerName."','".$ItemQtys."','".$TotalAmount."','".$JEEmployeeCode."','".$AEEmployeeCode."','".$EXnEmployeeCode."','".$WardNo."','".$AreaName."','".$AddedDate."')";
		   $db->query($insert);
