...
function AddProposedWork($db){
   ...
   $sql="insert into cw_proposedworks (WardNo,ProposerName,JEEmployeeCode,AEEmployeeCode,EXnEmployeeCode,CEEmployeeCode,WorkName,EstimatedAmount,ProposedWorkDate) values ('$WardNo','$ProposerName','$JEEmployeeCode','$AEEmployeeCode','$EXnEmployeeCode','$CEofficers','$WorkName','$EstimatedAmount','$ProposedWorkDate')";
	$db->query($sql);
	return 1;
}
