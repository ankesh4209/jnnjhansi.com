...
$db->open() or die($db->error());
 ...
 if($_GET['value']=='parsad') {
     ...
     if($db->num_rows())
    {
      ...
      $c_corporator.="<option value='' style='font-family:Kruti Dev 011;font-size:13px;'><span >Ikk”kZnx.k</option>";
...
$c_corporator.="<select  name='CorporatorId' onchange='ShowWards(this.value)'>
                    <option value='' style='font-family:Kruti Dev 011;font-size:13px;'><span >Ikk”kZnx.k</option>";
      $c_corporator.="</select>";
