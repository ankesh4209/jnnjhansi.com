...
$db1->open() or die($db1->error());
    ...
    $url1="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=JNNJHS&password=JNNJHS&senderid=JNNJHS&to=$ccontact&msg=$message1";
    //$file1=fopen("$url1","r");
    fclose("$file1");
    
    $url2="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=JNNJHS&password=JNNJHS&senderid=JNNJHS&to=$offcontact&msg=$message2";
    //$file2=fopen("$url2","r");
    fclose("$file2");
    
    $url3="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=JNNJHS&password=JNNJHS&senderid=JNNJHS&to=$con_contact&msg=$message3";
    //$file3=fopen("$url3","r");
    fclose("$file3");
