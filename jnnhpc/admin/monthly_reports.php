...
function viewcomplainant($db,$db1,$sdate,$edate,$category)
 {
  ...
  if($edate!="")
   ...
   $date_diff=$date_diff/(24*60*60);
			  ...
			  $total_query="select count(*) as total from complainant where 1=1 and ComplainType='0' and department='$nature' $sdate1 $edate1 ";
			
			  $pending_query="select  count(*) as pending  from complainant where 1=1 and ComplainType='0' and status='0' and department='$nature' $sdate1 $edate1";

			  $dispose_query="select  count(*) as dispose from complainant where 1=1 and ComplainType='0' and status='1' and department='$nature' $sdate1 $edate1";
			  
			  $default_query="select  count(*) as totaldefault from complainant where 1=1 and ComplainType='0' and status='0' and department='$nature' $sdate1 $edate1 $default_condition1";
		   ...
		   $complain_list="<tr>
                       <td align='left' align='left' style='padding-left:10px;'>$nature_name</td>
		...
		if($db->num_rows())
		{
	      ...
	      $cmode=stripslashes($rows['c_mode']);
			  ...
			  $complain_list.="<tr>
				...
				$complain_list.="<tr>
                           <td  align='left' style='padding-left:10px;'>$dep_name</td>
                           <td align='center'>$total</td>
