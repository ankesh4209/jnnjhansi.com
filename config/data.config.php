...
// <MENTION HERE DIRS/FILES NAME WHICH MUST HAVE WRITEABLE BY WEBSERVER>
       ...
       $DOCUMENT_ROOT                    = $_SERVER['DOCUMENT_ROOT'];
        ...
        $DB_USERNAME                    = "jnnjhrqb_test";              // Database Username
        $DB_PASSWORD                    = "?)x7,Bhy=Gcm";              // Password for the Db User
        //$DB_USERNAME                    = "jnnjhrqb_jnnjhan";              // Database Username
        //$DB_PASSWORD                    = "jnnjhan#123";              // Password for the Db User
        $DB_NAME                        = "jnnjhrqb_jnnjhan1sattva";              // Database name
