...
function GetCategory($db)
 ...
 {
	global $edit_items;
	$sql="SELECT i.ItemId as ItemId,i.ItemName as ItemName,s.Qty as Qty FROM epr_items as i INNER JOIN epr_stocks as s ON i.ItemId=s.ItemId order by i.ItemName ";
    $row=$db->query($sql);
     if($db->num_rows())
    {
