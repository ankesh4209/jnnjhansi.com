...
$id=$_GET['aid'];
GetLetter($db,$db1,$id);
$PAGE_CONTENTS	= ReadTemplate("../$TEMPLATE_DIR/admin/print_15letter.html");
...
function GetLetter($db,$db1,$id)
 {
    global $rno,$name,$fname,$address,$reg_date,$d_name,$subject,$question,$currentyear,$nextyear,$newreg_date;
