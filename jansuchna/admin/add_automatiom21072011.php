...
if($_POST['submit']!='')
 {
       ...
       echo "<script type='text/javascript'>
        <!-- 
         window.location = 'automation.php'
        //-->
        </script>";   
 }
...
function adddetails($db,$db1)
 {
      ...
      $phone=$_POST['phone'];
      $resipt=stripslashes($_POST['resipt']);
     ...
     if($off_phone!="")
     {
      $u_message="Reference%20No.%20$reg_new/Reg.%20Date%20$msg_date/Target%20Date%20$msg_trg_date/For%20more%20detail%20Pls%20contact%20Jan%20Suchana%20Anubhag,%20Nagar%20Nigam%20Jhansi.";
     ...
     $url2="http://api.mVaayoo.com/mvaayooapi/MessageCompose?user=jdajhansi@gmail.com:jhansi0510&senderID=JDA-JHS&receipientno=$contact_no&msgtxt=$user_message";
     $file2=fopen("$url2","r");
     fclose("$file2");
     
     $url3="http://api.mVaayoo.com/mvaayooapi/MessageCompose?user=jdajhansi@gmail.com:jhansi0510&senderID=JDA-JHS&receipientno=$contact_no&msgtxt=$other_message";
     $file3=fopen("$url3","r");
     fclose("$file3");
    
     $url1="http://api.mVaayoo.com/mvaayooapi/MessageCompose?user=jdajhansi@gmail.com:jhansi0510&senderID=JDA-JHS&receipientno=$je_no&msgtxt=$je_message";
     $file1=fopen("$url1","r");
     fclose("$file1"); */
