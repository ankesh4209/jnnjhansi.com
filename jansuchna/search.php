...
if($_POST['submit']!="")
{
 ...
 $PAGE_CONTENTS	= ReadTemplate("$TEMPLATE_DIR/searchResult.html");
}
else
{
     ...
     while($rows=$db->fetch_array($res))
     {
      ...
      $complain_status=$rows['app_status'];
       ...
       if($complain_status==1)
        ...
        {
          $status="Complete";
          $print_status="<a href=\"javascript: void(0)\" onclick=\"window.open('admin/print_complete.php?aid=$aid','windowname1','width=650, height=550,scrollbars=yes'); return false;\">Print</a>";
        }
