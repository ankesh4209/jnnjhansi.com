...
$PAGE_CONTENTS	= ReadTemplate("../$TEMPLATE_DIR/admin/add_officer.html");
...
function addofficer($db)
 {
     ...
     $email=$_POST['email'];
      ...
      $insert="insert into officer(off_code,off_desi,off_department,off_contno1,officer_name,officer_add,officer_contno,email) 
               values('$offcode','$offdesi','$department','$scontact1','$sfname','$saddress','$scontact','$email')";
      $db->query($insert);
