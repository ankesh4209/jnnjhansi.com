    ...
    $group=$_POST['group'];
     ...
     while($rows=$db->fetch_array())
     {
       ...
       $off_message="<html xmlns='http://www.w3.org/1999/xhtml' lang='hi'>
                      ...
                      <body>
                        <table width='100%' cellsapcing='5' cellpadding='5'>
                         <tr><td>Message:</td><td>$tomessage</td></tr>
                        </table>
                      </body>
                      </html>";
                      
      @mail($email,$off_subject,$off_message,$headers);
       
     }
     
    $PROPMT="Mail Sent Successfully";
 }
...
$PAGE_CONTENTS	= ReadTemplate("../$TEMPLATE_DIR/admin/bulk_email.html");
