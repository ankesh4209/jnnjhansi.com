...
{
   global $cid,$cname,$dis,$disposal_text,$caddress,$ccontno,$c_regno,$cdetail,$nature,$cmodetype,$officer,$departname,$cdate,$ccategory
          ,$ctime,$cnewspaper,$cmode,$conofficer,$tdate,$add_phone1,$city;
