...
$PAGE_CONTENTS	= ReadTemplate("../$TEMPLATE_DIR/admin/monthly_reports.html");
...
function viewcomplainant($db,$db1,$sdate,$edate,$category)
 {
  ...
  if($edate!="")
   ...
   $date_diff=$date_diff/(24*60*60);
			  ...
			  $total_query="select count(*) as total from complainant where 1=1 and department='$nature' $sdate1 $edate1 ";
			
			  $pending_query="select  count(*) as pending  from complainant where 1=1 and status='0' and department='$nature' $sdate1 $edate1";

			  $dispose_query="select  count(*) as dispose from complainant where 1=1 and status='1' and department='$nature' $sdate1 $edate1";
			  
			  $default_query="select  count(*) as totaldefault from complainant where 1=1 and status='0' and department='$nature' $sdate1 $edate1 $default_condition1";
		   ...
		   $complain_list="<tr>
                       <td align='center' align='left' style='padding-left:10px;'>$nature_name</td>
                       <td align='center'>$total</td>
                       <td align='center'><a href=\"javascript: void(0)\" onclick=\"window.open('monthly_reportsprint.php?dep=$nature&sdate=$sdate&edate=$edate&status=0','windowname1','width=750, height=650,scrollbars=yes'); return false;\">$pending</td>
                       <td align='center'><a href=\"javascript: void(0)\" onclick=\"window.open('monthly_reportsprint.php?dep=$nature&sdate=$sdate&edate=$edate&status=1','windowname1','width=750, height=650,scrollbars=yes'); return false;\">$dispose</td>
                       <td align='center'><a href=\"javascript: void(0)\" onclick=\"window.open('monthly_reportsprint.php?dep=$nature&sdate=$sdate&edate=$edate&status=2','windowname1','width=750, height=650,scrollbars=yes'); return false;\">$default</td>
                       </tr>";
	      ...
	      $cmode=stripslashes($rows['c_mode']);
			  ...
			  $complain_list.="<tr>
				...
				$complain_list.="<tr>
                           ...
                           <td align='center'>$total</td>
                           <td align='center'><a href=\"javascript: void(0)\" onclick=\"window.open('monthly_reportsprint.php?dep=$rows[nature_id]&sdate=$sdate&edate=$edate&status=0','windowname1','width=750, height=650,scrollbars=yes'); return false;\">$pending</td>
                           <td align='center'><a href=\"javascript: void(0)\" onclick=\"window.open('monthly_reportsprint.php?dep=$rows[nature_id]&sdate=$sdate&edate=$edate&status=1','windowname1','width=750, height=650,scrollbars=yes'); return false;\">$dispose</td>
                           <td align='center'><a href=\"javascript: void(0)\" onclick=\"window.open('monthly_reportsprint.php?dep=$rows[nature_id]&sdate=$sdate&edate=$edate&status=2','windowname1','width=750, height=650,scrollbars=yes'); return false;\">$default</td>
                           </tr>";
			$GTotal+=$total;
			$GPending+=$pending;
			$GDisposed+=$dispose;
			...
			/*$complain_list.="<tr>
                           ...
                           <td align='center'><b>Total:&nbsp;$GDisposed</b></td>
						    <td align='center'><b><a href='javascript: void(0)' onclick='window.open(\'print_glance.php?zone=__department__&sdate=__sdate__&edate=__edate__\','windowname1','width=650, height=550,scrollbars=yes'); return false;\'><input type='button' name='click' value='Print' class='button'></a></b></td>
                           </tr>";*/
			$complain_list.="<tr>
                           <td align='center' align='left' style='padding-left:10px;'>&nbsp;</td>
                           <td align='center'><b>Total:&nbsp;$GTotal</b></span></td>
                           <td align='center'><b>Total:&nbsp;$GPending</b></td>
                           <td align='center'><b>Total:&nbsp;$GDisposed</b></td>
						    <td align='center'><b><a href='javascript: void(0)' onclick='window.open(\"print_glance.php?zone=$category&sdate=$p_sdate&edate=$p_edate\",\"windowname1\",\"width=650, height=550,scrollbars=yes\")'><input type='button' name='click' value='Print' class='button'></a></b></td>
                           </tr>";
		}
