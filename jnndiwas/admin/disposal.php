...
if($_POST['submit']!='')
 {
   ...
   echo "<script type='text/javascript'>
        <!-- 
         window.location = 'complainant.php?d=1'
        //-->
        </script>";  
 }
...
$PAGE_CONTENTS	= ReadTemplate("../$TEMPLATE_DIR/admin/disposal.html");
...
function editcomplainant($db,$db1)
{
  ...
  $add_phone=$_REQUEST['add_phone'];
    ...
    $message1="Your%20Comp%20No.%20$cid%20has%20been%20disposed/to%20get%20more%20details%20pls.%20contact%20Jan%20Suchna%20Prakoshth%20Nagar%20Nigam%20Jhansi%20or%20Visit%20www.jnnjhansi.com";
    $message2="Comp%20No.$cid%20has%20been%20disposed%20and%20closed";
 
     $contactno=$_REQUEST['contact'];
   
    $url1="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=CROPSOFT&password=D@ve23&senderid=JNNJHS&mobileno=$contactno&msgtxt=$message1";
    $file1=fopen($url1,"r");
    fclose("$file1");
  
    $url2="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=CROPSOFT&password=D@ve23&senderid=JNNJHS&mobileno=$con_contact&msgtxt=$message2";
    $file2=fopen("$url2","r");
    fclose("$file2");
