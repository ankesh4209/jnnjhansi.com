...
$report1="select id,activity_no,party,department,dhara,ref_lawer,department,schedule_date,cur_discuss_date,next_discss_date,property_desc FROM addcase WHERE case_status='PENDING' ".$where." order by id desc";
...
<div>Total : <?=$total?>&nbsp; &nbsp;&nbsp;&nbsp;
 <a href="javascript:void();" onclick="javascript:window.open('print_report_pending.php?from_date=<?=$search_from_date?>&to_date=<?=$search_to_date?>','mywin','toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=0,width=678,height=500,top=50,left=100');">Print</a>
</div>
</div><br />
</div>
</div>
