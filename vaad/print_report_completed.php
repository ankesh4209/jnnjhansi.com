...
if($search_from_date!='' && $search_to_date!='') {
   $where=" and result_date>='$search_from_date' and result_date<='$search_to_date'";
} else {
   $where="";
}

$report1="select id,activity_no,party,department,dhara,ref_lawer,department,schedule_date,result_date,cur_discuss_date,next_discss_date,property_desc,description FROM addcase WHERE case_status='COMPLETED' ".$where." order by id desc";
...
<div class="wrapper" style="width:750px;">
  <table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td colspan="10"><h2>Jhansi Municipal Corporation Completed Report </h2></td>
    </tr>
    <tr >
    ...
    <th  align="center"  style="font-family: kruti_dev_010regular;font-size:16px;width:100px;"><strong>fu.kZ; frfFk</strong></th>  
    ...
    <th align="center" class="newtxt1" style="font-family: kruti_dev_010regular;font-size:18px;"><strong>lEifRr fooj.k </strong></th>
      ...
      <td height="25" align="center" ><?php echo strftime("%d-%m-%Y", strtotime($row->result_date));?></td>
