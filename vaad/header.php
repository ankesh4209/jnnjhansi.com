...
?>   <div class="menu">
 			<ul>
			<li class="<?=$active_master?> first"><a href="index.php?page=advocate">Masters</a></li>
			 <li class="<?=$active2?>"><a href="index.php?page=caselist">Case List</a></li>
			 <li class="<?=$active3?>"><a href="index.php?page=addcase">Add Case</a></li>
			 <li class="<?=$active4?>"><a href="index.php?page=userlist">View User</a></li>
			 <li class="<?=$active5?>"><a href="index.php?page=adduser">Add User</a></li>
...
<?php } elseif($_SESSION['usertype']=='USER'){ ?>
 <div class="menu">
            ...
            <li class="<?=$active3?>"><a href="index.php?page=caselist">View Mad</a></li>			
			</ul>
</div>
<?php } else { ?>
