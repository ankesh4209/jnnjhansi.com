...
function GetCategory($db,$ItemType)
 {
    ...
    $row=$db->query($sql);
      ...
      $category.="<option value=''>lkexzhq dk izdkj pqu</option>";
	  ...
	  while($res=$db->fetch_array($row))
       {
		 ...
		 if($DepartmentId==$DeptId){
			 $departments.="<option value='$DepartmentId' style='font-family: kruti_dev_010regular;font-size:15px;' selected>$DepartmentName</option>";
		 }else{
