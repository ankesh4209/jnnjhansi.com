...
$db1->open() or die($db1->error());
 ...
 if($_GET['ItemType']!='') {
    $sql="SELECT i.ItemId as ItemId,i.ItemName as ItemName,s.Qty as Qty FROM epr_items as i INNER JOIN epr_stocks as s ON i.ItemId=s.ItemId where i.ItemType='".$_GET['ItemType']."'";
    $row=$db->query($sql);
     if($db->num_rows())
    {
      $c_items.="<select  name='ItemId'  style='font-family: kruti_dev_010regular;font-size:15px;'>";
      $c_items.="<option value=''>lkexzh pqu</option>";
