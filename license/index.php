...
error_reporting(1);
$pageSuper = array('addlicense', 'downloadform', 'licenselist', 'adduser', 'userlist', 'location', 'business', 'addbusiness', 'addlocation', 'vehicle', 'addvehicle', 'category', 'addcategory', 'recruiters', 'addrecruiter', 'addsource', 'report1', 'report2', 'report3', 'report4');
$pageHR = array('licenselist', 'downloadform', 'addlicense', 'mrflist', 'mrf', 'recruiter', 'offered', 'joined', 'oar', 'recoffered', 'mrf_closed');
...
if ($_SESSION['usertype'] == 'USER' and ! in_array($_GET['page'], $pageHR))
    header("location:index.php?page=licenselist");
                ...
                <div id="wrapper">
                    ...
                    <div id="header_wrapper">
                        <div id="header">
                            ...
                            <?php if (!empty($_SESSION['username']) && $_GET['task'] != 'logout') {
                                ?>
                                <div id="logged_in" class="white">
                                    <span id="servertime"></span>
                                    <a href="index.php?page=logout" class="logoutbt" title="Logout">Logout </a>
                                    <div class="user_info">Logged in as <strong><?= $_SESSION['username'] ?></strong> </div>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
