...
if(!empty($_GET['id']))
{
$res = $obj->showdata('category','name',$_GET['id']);
...
{
$id=$_POST['id'];
if($id) $obj->saveMaster('category',$id);
else $obj->saveMaster('category');	
header("location:index.php?page=category&msg=Data has been saved successfully");
}
?>
...
<table width="40%" align="center" >
  <tr>
    <td width="13%"><strong><span style="font-family: kruti_dev_010regular;font-size:18px;">Js.kh dk uke</span></strong></td>
