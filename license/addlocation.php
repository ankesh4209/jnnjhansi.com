...
if(!empty($_GET['id']))
{
$res = $obj->showdata('location','name',$_GET['id']);
...
{
$id=$_POST['id'];
if($id) $obj->saveMaster('location',$id);
else $obj->saveMaster('location');	
header("location:index.php?page=location&msg=Data has been saved successfully");
}
?>
...
<table width="40%" align="center" >
  <tr>
    <td width="13%"><strong><span style="font-family: kruti_dev_010regular;font-size:18px;">izfr&#8217;Bku</span></strong></td>
