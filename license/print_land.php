...
$address=$row->address;
$mobno=$row->mobno;
$date_month= date('n',strtotime($row->updated_date));
$date_year= date('Y',strtotime($row->updated_date));
//die;
if($date_month>3) {
  $reg_date= '01-04-'.$date_year;
  $exp_date= '31-03-'.((int)$date_year+1);
} else {
  $reg_date= '01-04-'.((int)$date_year-1);
  $exp_date= '31-03-'.$date_year;
}
  ...
  <div class="licence">
    ...
    <ul>
     ...
     <!-- <li style="font-family:'kruti_dev_010regular';">
      ...
      <li style="font-family:'kruti_dev_010regular';">budks uxj fuxe >k¡lh lhekUrxZr izfr’Bku
        <input name="" type="text" style="font-family: 'kruti_dev_010regular';font-size:17px;font-weight:bold;width:320px;" value="<?php echo str_replace("\\","",$btype);?>" readonly="true"/>
      </li>
      <li style="font-family:'kruti_dev_010regular';">fLFkr
        <input name="" type="text" style="font-family: 'kruti_dev_010regular';font-size:17px;width:570px;font-weight:bold;" value="<?php echo str_replace("\\","",$situate);?>" readonly="true"/>
        fnukad
    ...
    <ul>
      <li style="font-family:'kruti_dev_010regular';">ykbZlsUl /kkjd dk uke Jh@Jherh@dq0
        <input name="" style="font-family: 'kruti_dev_010regular';font-size:17px;width:250px;font-weight:bold;" type="text" value="<?php echo str_replace("\\","",$name);?>" readonly="true"/>
      </li>
      <li style="font-family:'kruti_dev_010regular';">firk@ifr dk uke-
        <input name="" style="font-family: 'kruti_dev_010regular';font-size:17px;width:250px;font-weight:bold;" type="text" value="<?php echo str_replace("\\","",$father_name);?>" readonly="true"/>
      </li>
      <li style="font-family:'kruti_dev_010regular';">fuokl
        <input name="" type="text" style="font-family: 'kruti_dev_010regular';font-size:17px;width:580px;font-weight:bold;" value="<?php echo str_replace("\\","",$address);?>" readonly="true"/>
      </li>
      <li style="font-family:'kruti_dev_010regular';">
        <input name="" type="text" style="width:235px;" readonly="true"/>
      </li>
      <li style="font-family:'kruti_dev_010regular';">O;olk; dk izdkj  &nbsp;
        <span style="font-family: 'kruti_dev_010regular';font-size:17px;font-weight:bold;width:300px"><?php echo str_replace("\\","",stripslashes($location)); ?></span>
