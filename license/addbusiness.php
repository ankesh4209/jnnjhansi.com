...
if(!empty($_GET['id']))
{
$res = $obj->showdata('business','name',$_GET['id']);
...
{
$id=$_POST['id'];
if($id) $obj->saveMaster('business',$id);
else $obj->saveMaster('business');	
header("location:index.php?page=business&msg=Data has been saved successfully");
}
?>
...
<table width="40%" align="center" >
  <tr>
    <td width="13%"><strong><span style="font-family: kruti_dev_010regular;font-size:18px;">O;olk; dk uke</span></strong></td>
