...
if($_POST['submit']!="")
 {
    ...
    $message1="Comp%20No.%20$regno/Date%20of%20complaint%20$cdate2/Target%20Date%20$tdate2/to%20get%20more%20details%20pls.%20contact%20Jan%20Samadhan%20Kendra,%20Jhansi%20Nagar%20Nigam%20Jhansi";
    $message2="Comp%20No.%20$regno/Date%20of%20complaint%20$cdate2/Target%20Date%20$tdate2/Mobile%20no%20of%20Complainant%20$add_phone/to%20get%20more%20details%20pls.%20contact%20Jan%20Samadhan%20Kendra,%20Jhansi%20Nagar%20Nigam%20Jhansi";
    
    //$url1="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=CROPSOFT&password=D@ve23&senderid=JNNJHS&receipientno=$add_phone&msgtxt=$message1";
		$url1="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=JNNJHS&password=JNNJHS&sendername=JNNJHS&mobileno=$add_phone&message=$message1";
    $file1=fopen("$url1","r");
    fclose("$file1");
    
    $url2="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=CROPSOFT&password=D@ve23&senderid=JNNJHS&mobileno=$con_contact&message=$message2";
