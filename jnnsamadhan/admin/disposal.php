...
function editcomplainant($db,$db1)
{
  ...
  $add_phone=$_REQUEST['add_phone'];
    ...
    $message1="Your%20Comp%20No.%20$cid%20has%20been%20disposed/to%20get%20more%20details%20pls.%20contact%20Jan%20Samadhan%20Kendra,%20Jhansi%20Nagar%20Nigam%20Jhansi";
    $message2="Comp%20No.$cid%20has%20been%20disposed%20and%20closed";
 
     $contactno=$_REQUEST['contact'];
   
     $url1="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=CROPSOFT&password=D@ve23&senderid=JNNJHS&mobileno=$contactno&message=$message1";
