...
function viewcomplainant($db,$db1,$sdate,$edate,$category,$WardId,$cmode)
 { 
  ...
  if($edate!="")
   ...
   $query="select * from complainant where 1=1 $WardId1 and ComplainType='1' $sdate1 $edate1 $category1 $cmode";
...
function viewAllcomplainant($db,$db1,$sdate,$edate,$category,$WardId,$cmode)
 {
  ...
  if($edate!="")
   ...
   $date_diff=$date_diff/(24*60*60);
	  ...
	  $query="select * from complainant where 1=1 $WardId1 and ComplainType='1' $sdate1 $edate1 $c_mode";
