...
error_reporting(0);
$pageSuper=array('addmaddata','madlist','interest','addinterest','adduser','userlist','mad','addworkdesc','workdesc','addmad','bank','addbank','contractor','addcontractor','recruiters','payamtlist','addpayamt','report1','report2','report3','report4');
$pageHR=array('addpaymnt','madlist','payamtlist','addpayamt','addmaddata','interest','addinterest','workdesc','addworkdesc');
