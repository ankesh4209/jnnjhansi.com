...
if(!empty($_GET['id']))
{
$res = $obj->showdata('workdesc','name',$_GET['id']);
...
{
$id=$_POST['id'];
if($id) $obj->saveMaster('workdesc',$id);
else $obj->saveMaster('workdesc');	
header("location:index.php?page=workdesc&msg=Data has been saved successfully");
}
?>
