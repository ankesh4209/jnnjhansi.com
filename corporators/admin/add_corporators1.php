...
function adddetails($db,$db1)
 {
	global $DOCUMENT_ROOT;
		 ...
		 previous_record_as_corporator,other_events,hobby,north,east,west,south,
		 job_start_date,first_meeting_date,job_end_date,ward_population,sc_population,sc_other_population,obc_population,cleaner_inspector_name
		 ,cleaner_inspector_mobno,hawaldar_name,hawaldar_mobno
		 )  
...
'$job_start_date','$first_meeting_date','$job_end_date','$ward_population','$sc_population','$sc_other_population','$obc_population','$cleaner_inspector_name','$cleaner_inspector_mobno','$hawaldar_name','$hawaldar_mobno'				   
				   )";
		  $db->query($insert);
		  $sid=$db->insert_id();
