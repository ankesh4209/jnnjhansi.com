...
function viewpage($db,$db1)
 {
   ...
   //$TOTAL_RECORDSET = $rowtotal'total'];
    ...
    $query="select * from cw_tenders cw_t inner join cw_estimation cw_e on cw_t.EstmtId=cw_e.EstmtId where $sql group by cw_e.EstmtId order by cw_e.WardNo ASC limit  $page, $MAX ";
