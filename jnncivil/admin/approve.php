...
GetTenderDetails($db1,$db,$TenderId);
...
function GetTenderDetails($db1,$db,$Tid){
    ...
    $sql="select * from contractors where ContractorId='".$ContractorId."'";
	$res=$db->query($sql);
	$rows1 = $db->fetch_array($res);
    $ContractorName=$rows1['ContractorName'];
}
?>
