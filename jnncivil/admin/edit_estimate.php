...
{
	global $MadId,$WorkName,$EmployeeId,$WardNo,$AreaName,$AddedDate,$srtItemQtys,$eid,$JEEmployeeCode,$AEEmployeeCode,$EXnEmployeeCode,$TotalAmount,$ProposerName,$ProposedDate;
