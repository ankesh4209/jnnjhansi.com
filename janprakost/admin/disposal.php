...
function editcomplainant($db,$db1)
{
  ...
  $add_phone=$_REQUEST['add_phone'];
    ...
    $message1="Your%20Comp%20No.%20$cid%20has%20been%20disposed.%20get%20more%20details%20pls%20visit%20www.jnnjhansi.com%20or%20call%2018001805140";
    $message2="Comp%20No.$cid%20has%20been%20disposed%20and%20closed";
 
     $contactno=$_REQUEST['contact'];
   
    //$url1="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=JNNJHS&password=JNNJHS&sms=$message1&mobiles=$contactno&senderid=JNNJHS";
    //$file1=fopen($url1,"r");
    //fclose("$file1");
  
    //$url2="http://trans.cropsoft.co.in/reseller/sendsms.jsp?user=JNNJHS&password=JNNJHS&sms=$message1&mobiles=$con_contact&senderid=JNNJHS";
    //$file2=fopen("$url2","r");
    //fclose("$file2");
