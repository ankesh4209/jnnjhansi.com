...
$PAGE_CONTENTS	= ReadTemplate("$TEMPLATE_DIR/emp_info.html");
...
function viewreports($db,$db1,$db2,$dept_id='',$radioDept,$radioSingle,$radioAll)
 {
   ...
   global $TOTAL_RECORDSET,$PAGE_NAVS,$department,$strdept,$emp_name,$emp_code,$sno,$EmployeePhoto,$ResidentialAdd,$MobileNo;
