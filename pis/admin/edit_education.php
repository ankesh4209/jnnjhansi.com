...
$PAGE_CONTENTS	= ReadTemplate("../$TEMPLATE_DIR/admin/edit_education.html");
...
//print_r($_POST);
  // die;
   ...
   {	    $query="update employeeinfo set 
		   ...
		   OtherEduInfo='".addslashes($OtherEduInfo)."' where EmployeeCode='$EmployeeCode'";
...
function  GetEmployeeDetails($db,$emp_code)
 {
   global $EmployeeCode,$Education,$Year,$University,$OtherEduInfo;
